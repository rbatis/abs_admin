...
*  前后端分离[Vue-JS](https://cn.vuejs.org/) +[Vue-AntDesign](https://www.antdv.com/docs/vue/introduce-cn/) + [Vue-AntDesign-Pro](https://www.antdv.com/docs/vue/introduce-cn/)
*  基于JwtToken的密码登录，图形验证码登陆，二维码扫码登陆,基础权限管理
